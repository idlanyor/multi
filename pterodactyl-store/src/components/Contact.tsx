...
export function Contact() {
  return (
    <section id="contact" className="py-20 px-4 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-800 dark:to-gray-900">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 group border border-gray-200 dark:border-gray-700"
          >
            ...
            <span className="text-green-600 dark:text-green-400 font-semibold">+62 895-3955-90009</span>
          </Link>
          ...
          >
            ...
            <span className="text-blue-600 dark:text-blue-400 font-semibold">Join Group WhatsApp</span>
          </Link>
        </div>

        <div className="mt-12 p-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg max-w-2xl mx-auto border border-gray-200 dark:border-gray-700">
